            ...
            <div className="row">
                ...
                <div className="card col-md-6 offset-md-3 offset-md-3 mt-4">
                    <div className="card-body">
                        ...
                        {/* <div className="form-outline mb-2 mt-3 col-4">
                            <label className="form-label" htmlFor="notificationType">Notification Type : </label>&emsp;

                            <div id="email" className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" name="notificationType" id="email" value="email" onChange={(e) => setNotificationType(e.target.value)} />
                                <label className="form-check-label" htmlFor="email">Email</label>
                            </div>

                            <div id="sms" className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" name="notificationType" id="sms" value="sms" onChange={(e) => setNotificationType(e.target.value)} />
